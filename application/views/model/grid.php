			...
			<th>
			  <div class="row">
				<div class="col-sm-8 m-t-xs m-b-xs">
					<a href="<?php echo site_url("model/form"); ?>"><button class="btn btn-primary" type="button"><span class="fa fa-plus"></span> Tambah Model</button></a>
				</div>
...
$(document).ready(function() {
	...
	DataGridDataSource.prototype = {
		...
		data: function (options, callback) {
			var url = '<?php echo site_url("model/grid_json"); ?>';
			var self = this;
